...
export const MessageContent = ({ children, className, ...props }: MessageContentProps) => (
  <div
    className={cn(
      // 13px text / 18px line-height at the 16px desktop root, in rem so the
      ...
      "is-user:dark flex w-fit min-w-0 max-w-full flex-col gap-2 text-[0.8125rem] leading-[1.125rem]",
